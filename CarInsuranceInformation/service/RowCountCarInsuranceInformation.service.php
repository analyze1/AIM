<?php
class RowCountCarInsuranceInformationService
{
	private $_context;
	...
	function countCarInsurance($valSearchAll,$valSqlUserLogin,$valPersonType)
	{
		...
		WHERE insuree.person = '$valPersonType' AND (
