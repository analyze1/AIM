...
var untidy=1; // how often do you want the flakes tidied up (high number is less often)
var sizes=36; // maximum size of flakes in pixels
var colour='#d2f7f5'; // colour of the snowflakes
...
function tidy_flakes() {
  var i;
  tidying=true;
  for (i=swide; i>=-146; i-=2) setTimeout('plough('+i+')', speed_car*(swide-i));
  setTimeout('tidying=false; offset=0;', speed_car*(swide-i));
}
