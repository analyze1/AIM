...
function calcfunc_inform() 
{
	...
	//var total_one = (parseFloat(total_age_driver3) - parseFloat(one)).toFixed(2); // ความเสียหายส่วนแรก
	...
	//var sum_pro1pro2 = (parseFloat(sum_pro_dis) + parseFloat(sum_prodis2)).toFixed(2); 
	...
	if(d_agent == "8+13")
	{
		...
		{				
			...
			if(vat1 != '0')
			{
				...
				var result_commition = (parseFloat(result_prb) - parseFloat(to_dis3) - parseFloat(commition1) + parseFloat(vehicle_tax) + parseFloat(service_charge)).toFixed(2);
			}
			else
			{
	...
	var result_commition_new = (parseFloat(result_commition) - parseFloat(dis_other)).toFixed(2); 
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	webForm_inform.other_inform.value = addCommas(to_dis3);
