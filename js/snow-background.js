snow = {
	...
	resize: function() {
		...
		snow.gt.addColorStop(0.0, '#f4f6f5');
		snow.gt.addColorStop(1.0, '#026889');
		 snow.ct.fillStyle = snow.gt;
	},
	start: function() {
		snow.cv = document.createElement('canvas');
		snow.cv.width = snow.cv.height = 5; // set initial size
		...
		// snow.cv.style.background='url(images/bgline1.jpg) top left repeat-x';
		snow.resize();
		var c = snow.count;
		snow.flakes = [];
		do {
