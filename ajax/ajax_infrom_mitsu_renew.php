                ...
                <div class='grid grid-cols-1 gap-6 sm:grid-cols-2' style='padding: 0.5rem; '>
                    ...
                    <div class="flex">
                        <div class="w-30 mr-2">
                            ...
                            <select name="person_inform" id="person_inform" class='w-100'
                                onchange="onkeyicard_clear(this.value)">
                        ...
                        <div class="w-100 mr-2">
                            ...
                            <span class='flex'>
                                ...
                                <input name="icard13" type="text" id="icard13" maxlength="1"
                                    onkeyup='onkeyicard("","icard13",event);' style='width:100%; text-align: center;'>
                            </span>
                        ...
                        <div class="w-30">
                            ...
                            <select id="title_inform" name="title_inform" class="w-100"
                                onchange="customerLastName(this.value);">
                    ...
                    <div class="flex">
                        <div class="mr-2" id='show_name_form'>
                            ...
                            <div id='show_name_text' class="flex">
                                ...
                                <input type='text' name="name_inform" id="name_inform" class='w-100'
                                    placeholder='ป้อนชื่อจริง' maxlength="100" value='' required />
                            </div>
                        </div>
                        <div class="" id='show_last_text'>
                            ...
                            <div class="flex">
                                ...
                                <input type='text' name="last_inform" id="last_inform" class='w-100'
                                    placeholder='ป้อนนามสกุล' maxlength="50" value='' required />
                            </div>
                        </div>
                    </div>
                    <div class="flex">
            ...
            <div class='grid grid-cols-1 gap-6 sm:grid-cols-2' style='padding: 0.5rem; '>
                <div class="flex">
                    ...
                    <div class="w-50">
                        ...
                        <select name="regis_date_inform" id="regis_date_inform" class="w-100">
                            ...
                            <?php $i = 0; $yyy = date("Y"); while ($i <= 21) { $cal = $yyy - $i; ?>
                ...
                <div class="flex">
                    ...
                    <div class="w-30 mr-2">
                        ...
                        <input name="cc_inform" type="number" id="cc_inform" class='w-100 mr-2' maxlength="4"
                            placeholder='ซีซี' value="" required>
                    </div>
                    <div class="w-30 mr-2">
                        <label for="">น.น.</label>
                        <input name="wg_inform" type="number" id="wg_inform" class='w-100 mr-2' maxlength="5"
                            placeholder='ตัน' value="" required>
                    </div>
                    <div class="w-30 mr-2">
                        <label for="">ที่นั่ง</label>
                        <input type="number" name="car_seat_inform" id="car_seat_inform" class='w-100'
                            placeholder='ที่นั่ง' value='' required>
                    </div>
                    <div class="w-100 mr-2">
            ...
            <div id="hiddenPremium" style="display: none;">
                    ...
                    <!-- <div>
                        <div class="w-20 mr-2">
                            ...
                            <input id="o_insure_inform" name="o_insure_inform" type="text"
                                value='<?php //echo $data_renew_array['n_insure']; ?>' class='w-100'>
                        </div>
                    </div> -->
                </div>
                <div style="padding: 0.5rem;display: flex;">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-1 w-30">
                        <div class="flex w-100">
                            <div class="w-30 mr-2">
                                ...
                                <input class='w-100' type="text" id="pre_inform" name="pre_inform" value="0.00"
                                    readonly>
                            </div>
                            <div class="w-30 mr-2">
                                <label for="">เบี้ยรวม</label>
                                <input class='w-100' type="text" id="total_sum_inform" name="total_sum_inform"
                                    value="0.00" readonly style='text-align:right;'>
                            </div>
                            <!-- <div class="w-100">
                            <label for="">ส่วนลด</label>
                            <input name="currentValue_inform" type="text" id="currentValue_inform"
                                style="display: none;" value="<?php //echo $comittion_a ?>" class='w-100' readonly="true">
                            ...
                            <div class="w-30 mr-2">
                                ...
                                <div class="flex">
                                    <input type="hidden" id='actCheck_inform' name='actCheck_inform' value="0" readonly
                                        style='text-align:right;'>
                                    <input class='w-100' type="hidden" id='prb_net_inform' name='prb_net_inform'
                                        readonly style='text-align:right;'>
                                    <select id="select_prb_inform" name="select_prb_inform" class='w-100 mr-2'
                                        onchange="handleCalculate(this.value, false)">
                                        ...
                                        ?>
                                        <option
                                            value="<?php echo number_format($tb_act_array['net_act'], 2, '.', ','); ?>">
                                            <?php echo $tb_act_array['id_act']; ?></option>
                                        <?php } ?>
                                    </select>
                                    <input class='w-100' type="hidden" id='prbNet_inform' name='prbNet_inform' value="0"
                                        readonly style='text-align:right'>
                                    <select name='act_sort_inform' id='act_sort_inform' class='w-100 mr-2'
                                ...
                                foreach ($result->fetchAll(2) as $fetcharr) {?>
                                    ...
                                    <input value="0.00" class='w-100' type="text" id="currentValue_prb_inform"
                                        name="currentValue_prb_inform" readonly style='text-align:right;'>
                                </div>
                            </div>
                            <div class="w-30 mr-2">
                                <label for="">เบี้ยรวม พ.ร.บ.</label>
                                <input value="0.00" class='w-100' type="text" id="total_prb_inform"
                                    name="total_prb_inform" readonly style='text-align:right;'>
                            </div>
                            <!-- <div class="w-100">
                    ...
                    <div class="w-10" style="padding-left: 1rem;">
                        ...
                        <div class="flex">
                            <input class="w-100" id="total_payment_inform" value="0.00" type="text"
                                name="total_payment_inform" readonly
                                style='text-align: center;    margin: 0;font-size: 1.5rem !important;font-weight: bolder;height: 106px;background: #03a9f400 !important;'>
                        </div>
                    </div>
                </div>
                ...
                <div style="padding: 0.5rem;">
                    <div style='background: white; border-radius: 5px;font-weight: bold;'>
                        <div
                            style="padding-left: 1rem;padding-right: 1rem;padding-top: 1rem;font-size: 19px !important; display: flex;">
                            ...
                            <div class="flex boxz" style="margin: 1rem; padding: 0.5rem;">
                                <div class="w-100">
                                    <div class='span12 e-span12 flex' style='<?php echo $css_margin ?>'>
                                        <!--text-->
                                        <div class='span12 e-span12'
                                            style=' <?php echo $css_margin . " " . $css_margin_font ?>'>
                                            <font><u>ความรับผิดต่อบุคคลภายนอก</u></font>
                                        </div>
                                    </div>
                                    <div class='span12 e-span12 flex' style='<?php echo $css_margin ?>'>
                                        <!--text-->
                                        <div class='span6 e-span6'
                                            style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                                        ...
                                        <!--number-->
                                        <div class='span3 e-span3'
                                            style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                                            <font style='<?php echo $css_margin_font_tab_right ?>'
                                                id='damage_out1_inform_show'>
                                            </font>
                                        </div>
                                        <!--unit-->
                                        <div class='span3 e-span3'
                                    ...
                                    <div class='span12 e-span12 flex'
                                        style='<?php echo $css_margin ?>border-bottom: 1px solid;'>
                                        <!--text-->
                                        <div class='span6 e-span6'
                                            style='<?php echo $css_margin . " " . $css_margin_font ?>'>
