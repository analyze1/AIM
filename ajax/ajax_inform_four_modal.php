...
$discountuse = array();
$sql = "SELECT * FROM tb_agent WHERE Type ='Mitsubishi' ORDER BY full_name ASC";
...
.design-ti {
    ...
    background: linear-gradient(165deg, #555555 22%, rgb(204, 138, 50) 22%, rgb(232, 189, 33) 22.7%, #555555 20%, rgba(255, 255, 255, .0)),
        linear-gradient(135deg, #555555 94.0%, rgb(232, 189, 33) 0%, rgb(204, 138, 50) 94.3%, rgb(212, 212, 212) 10%);
}
...
@media only screen and (max-width: 1160px) {
    .design-ti {
        ...
        height: 45px;
        background-color: rgb(212, 212, 212);
        background: linear-gradient(165deg, #555555 22%, #555555 22%, #555555 22.5%, #555555 20%, rgba(255, 255, 255, .0)),
            linear-gradient(135deg, #555555 94.0%, rgb(232, 189, 33) 0%, rgb(204, 138, 50) 94.3%, rgb(212, 212, 212) 10%);
    }
}
...
<form name="webForm_inform" id="webForm_inform">
    <div class='font-design'>
        ...
        <div class='design-form span12' style='<?php echo $css_margin ?> margin-bottom:20px;'>
            <div class="alert alert-error" style="margin-bottom: 5px;"><i class="icon-warning-sign"></i> การค้นหาต้องลบข้อความแล้วพิมพ์ใหม่ทุกครั้ง</div>
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>สาขาแจ้งงาน :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?> '>
                    <?php
                    
                    $sql = "SELECT AgentCode FROM partner_code_center WHERE Type ='Mitsubishi' AND DealerID = '$data_renew_array[login]'";
                    $agentKey = PDO_CONNECTION::fourinsure_insured()->query($sql)->fetch(7);
                    echo "<select name='agent_inform' id='agent_inform' value='' onchange='onChange(this.form), calcfunc_inform()'>";
                        $comittion_a = '0';
                        echo "<option  value= 'N' disabled >--กรุณาเลือกตัวแทน--</option>";
                        foreach ($resultAgentAll as $x) {
                            $id_agent = $x['id_agent'];
                            $name_agent = $x['full_name'];        
                            if($agentKey == $id_agent) {
                                echo "<option value='$id_agent' selected>$name_agent</option>";
                            }
                        }
                    echo "</select>";
                    ?>
                </div>
                <div class='span2 e-span2'
                    style='<?php echo $css_margin . " " . $css_margin_font ?> <?php echo $display_hide ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>ผู้แจ้ง :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?> <?php echo $display_hide ?>'>
                    ...
                    echo "<input type='text' name='emp_inform' list='emp_inform' class='e-span10' placeholder='เลือกผู้แจ้ง' onchange=\"onChange(this.form), calcfunc_inform()\" >";
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?> <?php echo $display_hide ?>'>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    ...
                    <input class="span2" type="hidden" id="show_q_auto_inform" name="show_q_auto_inform"
                        readonly="readonly" />
                    <input name="currentText_inform" type="hidden" id="currentText_inform"
                        value="<?php echo $edit_nameuser; ?>" />
                    <!-- เอาไว้ส่งอัพเดทสถานะการแจ้งงาน -->
                    <input type="hidden" name="end_date_old_inform" id="end_date_old_inform" size="18" maxlength="50"
                        value='' />
                    <input type="hidden" name="id_data_old_inform" id="id_data_old_inform" size="18" maxlength="50"
                        value='<?php echo $id_data_old; ?>' />
                    <input type="hidden" name="car_body_old_inform" id="car_body_old_inform" size="18" maxlength="50"
                        value='' />
                </div>
                <div class='span2 e-span2' style='<?php echo $css_margin ?>'>
                    <input style="font-size:18px;text-align:right;" type="radio" id="status_vip1_inform"
                        name="status_vip_inform" value="N" checked /><strong
                        style="font-size:16px;">&nbsp;ลูกค้าปกติ</strong>
                </div>
                <div class='span2 e-span2' style='<?php echo $css_margin ?>'>
                    <input style="font-size:18px;text-align:right;" type="radio" id="status_vip2_inform"
                        name="status_vip_inform" value="Y" /><strong style="font-size:16px;">&nbsp;ลูกค้า VIP</strong>
                </div>
            </div>
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>บุคคล/นิติบุคคล :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <select name="person_inform" id="person_inform" class='e-span10'>
                        <option value="0">--เลือก--</option>
                        <option value="1" <?php 
                        if ($data_renew_array['person'] == '1') {
                                                echo "selected";
                                            } ?>>บุคคลธรรมดา
                        </option>
                        ...
                        <option value="3" <?php if ($data_renew_array['person'] == '3') {
                                                echo "selected";
                                            } ?>>
                            บุคคลในนามบริษัท</option>
                    </select>
                </div>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>เลขบัตร/เลขนิติบุคคล :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <input type="text" id="icard_inform" name="icard_inform" class='e-span10' value='<?php if ($data_renew_array['person'] == '2') {
                                                                                                            echo $data_renew_array['icard'];
                                                                                                        } else {
                                                                                                            echo $data_renew_array['icard'];
                                                                                                        } ?>' />
                </div>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                ...
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <select id="title_inform" name="title_inform" class='e-span10 class_title_inform'
                        onchange='js_title_inform();'>
                        <option value="<?php if (!empty($data_renew_array['title'])) {
                                            echo $data_renew_array['title'];
                                        } else {
                                            echo "0";
                                        } ?>" selected>
                            <?php if (!empty($data_renew_array['title'])) {
                                echo $data_renew_array['title'];
                            } else {
                                echo "--เลือกคำนำหน้า--";
                            } ?>
                        ...
                        $select_titlename_query = PDO_CONNECTION::fourinsure_insured()->query($select_titlename_sql)->fetchAll(2);
                        foreach ($select_titlename_query as $x) { ?>
                        <option value='<?php echo $x['prename'] ?>'><?php echo $x['prename'] ?></option>
                        <?php } ?>
                    </select>
                </div>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>ชื่อจริง-นามสกุล :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <div class='span6 e-span6' style='<?php echo $css_margin ?>' id='show_name_form'>
                        <input type='text' name="name_inform" id="name_inform" class='e-span10'
                            placeholder='ป้อนชื่อจริง' maxlength="100"
                            value='<?php echo $data_renew_array['n_name']; ?>' />
                    </div>
                    <div class='span6 e-span6' style='<?php echo $css_margin ?>' id='show_last_form'>
                        <input type='text' name="last_inform" id="last_inform" class='e-span10'
                            placeholder='ป้อนนามสกุล' maxlength="50"
                            value='<?php if (!empty($data_renew_array['last'])) {
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?> <?php echo $display_hide ?>'>
                ...
                <div class='span2 e-span2' style='<?php echo $css_margin ?>'>
                    <input type="radio" id="SendAdd1_inform" name="SendAdd_inform" value="1" checked /><strong
                        style='font-size:16px;'>&nbsp;ที่อยู่ตามกรมธรรม์</strong>
                </div>

                <div class='span2 e-span2' style='<?php echo $css_margin ?>'>
                    <input type="radio" id="SendAdd2_inform" name="SendAdd_inform" value="2" /> <strong
                        style='font-size:16px;'>&nbsp;ที่อยู่ในการจัดส่ง</strong>
                </div>
                <div class='span2 e-span2'></div>
                <div class='span4 e-span4' style='display: none;<?php echo $css_margin ?>' id='divTempText'>
                    <div class="alert alert-info" id='tempText'>
                        <p>ข้อมูลสำรอง</p>
                    </div>
                </div>
            </div>
            ...
            <div class='span12 e-span12 bk-event' id='Send2_inform' style='<?php echo $css_margin ?> display:none;'>
                <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <input type="text" name="send_add" id="send_add" class='e-span10'>
                        </div>
                    </div>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        <div class='span6 e-span6' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <input type="text" name="send_group" id="send_group" class='e-span10'>
                        </div>
                    </div>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        <div class='span6 e-span6' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <input type="text" name="send_town" id="send_town" class='e-span10'>
                        </div>
                    </div>
                </div>
                <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <input type="text" name="send_lane" id="send_lane" class='e-span10'>
                        </div>
                    </div>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        <div class='span6 e-span6' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <input type="text" name="send_road" id="send_road" class='e-span10'>
                        </div>
                    </div>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        <div class='span6 e-span6' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <select name="send_province" id="send_province" class='e-span10'
                ...
                <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <select name="send_amphur" id="send_amphur" class='e-span10'
                    ...
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <select name="send_tumbon" id="send_tumbon" class='e-span10'
                    ...
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <select name="send_post" id="send_post" class='e-span10'>
                                <option value=''>--กรุณาเลือก--</option>
                            </select>
                        </div>
                    </div>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>สถานที่ :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <input type="text" name="in_career_inform" class='e-span10' id="in_career_inform" value='<?php //echo $data_renew_array['career']; 
                                                                                                                ?>'>
                </div>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>บ้านเลขที่ :</font>
                ...
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <input type="text" name="add_inform" id="add_inform" value='<?php echo $data_renew_array['add']; ?>'
                        class='e-span10'>
                </div>
            </div>
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>หมู่ที่ :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <input type='text' name="group_inform" id="group_inform"
                        value='<?php echo $data_renew_array['group']; ?>' class='e-span10'>
                </div>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>ชื่อหมู่บ้าน :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <input type='text' id="town_inform" class='e-span10' name="town_inform"
                        value='<?php echo $data_renew_array['town']; ?>'>
                </div>
            </div>
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                ...
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <input type='text' id="lane_inform" class='e-span10' name="lane_inform"
                        value='<?php echo $data_renew_array['lane']; ?>' />
                </div>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>ถนน:</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <input type='text' id="road_inform" class='e-span10' name="road_inform"
                        value='<?php echo $data_renew_array['road']; ?>' />
                </div>
            </div>
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                ...
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <select name='province_inform' id='province_inform' class='e-span10'>
                ...
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <select name="amphur_inform" id="amphur_inform" class='e-span10'>
                        <?php
                        ...
                        <?php
                        foreach ($tb_amphur_query->fetchAll(2) as $tb_amphur_array) { ?>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                ...
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <select name="tumbon_inform" id="tumbon_inform" class='e-span10'>
                        <?php
                ...
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <select name="postal_inform" id="postal_inform" class='e-span10'>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>อีเมล์ :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <input type="text" id="email_inform" class='e-span10' name="email_inform"
                        value='<?php echo $data_renew_array['email']; ?>'>
                </div>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>เบอร์มือถือ 1 :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <input type="text" id="tel_mobile_inform" name="tel_mobile_inform" class='e-span10'
                        value='<?php echo $data_renew_array['tel_mobi']; ?>'>
                </div>
            </div>
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>เบอร์มือถือ 2 :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <input type="text" id="tel_mobile2_inform" name="tel_mobile2_inform" class='e-span10'
                        value='<?php echo $data_renew_array['tel_mobi_2']; ?>'>
                </div>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>เบอร์บ้าน/ที่ทำงาน :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <input type="text" id="tel_home_inform" name="tel_home_inform"
                        value='<?php echo $data_renew_array['tel_home']; ?>' class='e-span10'>
                </div>
            </div>
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>เบอร์แฟกซ์ :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <input type="text" id="tel_fax_inform" name="tel_fax_inform"
                        value='<?php echo $data_renew_array['fax']; ?>' class='e-span10'>
                </div>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>ID Line :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <input type="text" id="id_line_inform" name="id_line_inform"
                        value='<?php echo $data_renew_array['id_line']; ?>' class='e-span10'>
                </div>
            </div>
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>อาชีพ :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <input type="text" id="id_vocation_inform" name="id_vocation_inform"
                        value='<?php echo $data_renew_array['vocation']; ?>' class='e-span10'>
                </div>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
        ...
        <div class='design-form span12' style='<?php echo $css_margin ?> margin-bottom:20px;'>
            <div class='span12 e-span12' style='<?php echo $css_margin ?> <?php echo $display_hide ?>'>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>ประเภทการใช้ :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <select name='cartype_inform' id='cartype_inform' class='e-span10'>
                        <?php
                ...
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>ลักษณะใช้งาน :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <?php
                    ...
                    ?>
                    <select name="car_id_inform" id="car_id_inform" class='e-span10'>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?> <?php echo $display_hide ?>'>
                ...
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <select name='cat_car_inform' id='cat_car_inform' class='e-span10'>
                        <option value='0'>--กรุณาเลือกประเภท--</option>
                        <?php
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                ...
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <select name="br_car_inform" id="br_car_inform" class='e-span10'>
                ...
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <select name="mo_car_inform" id="mo_car_inform" class='e-span10'>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>ปีจดทะเบียน :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <div class='span8 e-span8' style='<?php echo $css_margin ?>'>
                        <select name="regis_date_inform" id="regis_date_inform" class='e-span10'
                            onchange="javascript:showCarAge();">
                    ...
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        <input name="year_old_inform" type="text" id="year_old_inform" class='e-span10' maxlength="3"
                            value='<?php if (!empty($data_renew_array['regis_date'])) {
                ...
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>ซีซี/น.น./ที่นั่ง :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        <?php $array_desc = explode('/', $data_renew_array['desc']); ?>
                        <input name="cc_inform" type="text" id="cc_inform" class='e-span10' maxlength="4"
                            placeholder='ซีซี' value="<?php echo $array_desc[1]; ?>">
                    </div>
                    <div class='span1 e-span1'
                        style='<?php echo $css_margin . " " . $css_margin_font ?> text-align:center;'>/</div>
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        <input name="wg_inform" type="text" id="wg_inform" class='e-span10' maxlength="5"
                            placeholder='น.น.'
                            value="<?php if (!empty($array_desc[2])) {
                    ...
                    <div class='span1 e-span1'
                        style='<?php echo $css_margin . " " . $css_margin_font ?> text-align:center;'>/</div>
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        <input type="text" name="car_seat_inform" id="car_seat_inform" class='e-span10'
                            placeholder='ที่นั่ง' value='<?php echo $array_desc[0]; ?>'>
                    </div>
                </div>
            </div>
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>เกียร์ :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <select name="gear_inform" size="1" id="gear_inform" class='e-span10'>
                ...
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>สีรถ :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <select name="car_color_inform" id="car_color_inform" class='e-span10'>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>วันหมดภาษีรถยนต์ :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <?php
                    ...
                    ?>
                    <input id="vat_car_inform" name="vat_car_inform" type="text"
                        value='<?php $edit_start_date = explode("-", $date_now);
                                                                                        $dtY = $edit_start_date[0];
                                                                                        echo $edit_start_date[2] . "/" . $edit_start_date[1] . "/" . $dtY; ?>' class='e-span10'
                        placeholder='คลิกที่นี้เพื่อเลือกวันที่วันหมดภาษี'>
                </div>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>ประเภททะเบียน :</font>
                </div>
                <div class='span4 e-span4' style='<?=$css_margin?>'>
                    <div class='span4 e-span4' style='<?=$css_margin?>'>
                        <select name="chose_carregis_inform" class='e-span10' id="chose_carregis_inform">
                            <option value="0">-ทะเบียน-</option>
                            <option value="1"
                                <?php if ($data_renew_array['car_regis'] == 'ป้ายแดง') { echo "selected"; } ?>>
                                ป้ายแดง</option>
                            <option value="2"
                                <?php if ($data_renew_array['car_regis'] != 'ป้ายแดง') { echo "selected"; } ?>>
                                ป้ายดำ</option>
                    ...
                    <!-- <div class='span6 e-span6' style='<?=$css_margin?>'>
                        <?php if($data_renew_array['car_regis']=='ป้ายแดง'){ ?>
                        <input name="car_regis_inform" type="text" style='display:none;' id="car_regis_inform"
                            class='e-span10' value="-">
                        <?php }else{ ?>
                        <input name="car_regis_inform" type="text" id="car_regis_inform" class='e-span10'
                            value="<?php echo $data_renew_array['car_regis']; ?>">
                        <?php } ?>
                    </div> -->
                    <div class='span5 e-span5' style='<?=$css_margin?>'>
                        <?php echo "<script> var _car_regis = `$data_renew_array[car_regis]`;</script>"; 
							if($data_renew_array['car_regis']=='ป้ายแดง'){ ?>
                        <div class="flx-important" id="showRegis" style="display:none;">
                            <input type='text' class='zip-group' name='car_regis1' id='car_regis1'
                                onkeyup='onkey_car_regis("car_regis2","car_regis1",event);' value='' maxlength='1'>
                            <input type='text' class='zip-group' name='car_regis2' id='car_regis2'
                                onkeyup='onkey_car_regis("car_regis3","car_regis2",event);' value='' maxlength='1'>
                            <input type='text' class='zip-group' name='car_regis3' id='car_regis3'
                                onkeyup='onkey_car_regis("car_regis4","car_regis3",event);' value='' maxlength='1'>
                            <span class="mr-5 txt-dash">-</span>
                            <input type='text' class='zip-group' name='car_regis4' id='car_regis4'
                                onkeyup='onkey_car_regis("car_regis5","car_regis4",event);' value='' maxlength='1'>
                            <input type='text' class='zip-group' name='car_regis5' id='car_regis5'
                                onkeyup='onkey_car_regis("car_regis6","car_regis5",event);' value='' maxlength='1'>
                            <input type='text' class='zip-group' name='car_regis6' id='car_regis6'
                                onkeyup='onkey_car_regis("car_regis7","car_regis6",event);' value='' maxlength='1'>
                            <input type='text' class='zip-group' name='car_regis7' id='car_regis7'
                                onkeyup='onkey_car_regis("","car_regis7",event);' value='' maxlength='1'>
                        </div>
                        <input name="car_regis_inform" type="text" style='display:none;' id="car_regis_inform"
                            value="<?php echo $data_renew_array['car_regis']; ?>">
                        <?php }else{ ?>
                        <div class="flx-important" id="showRegis">
                            <input type='text' class='zip-group' name='car_regis1' id='car_regis1'
                                onkeyup='onkey_car_regis("car_regis2","car_regis1",event);' value='' maxlength='1'>
                            <input type='text' class='zip-group' name='car_regis2' id='car_regis2'
                                onkeyup='onkey_car_regis("car_regis3","car_regis2",event);' value='' maxlength='1'>
                        ...
                        <input name="car_regis_inform" type="text" id="car_regis_inform" class='span4'
                            style='display:none;' value="<?php echo $data_renew_array['car_regis']; ?>">
                        <?php } ?>
                    </div>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>จังหวัดทะเบียน :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <select name='car_regis_pro_inform' id='car_regis_pro_inform' class='e-span10'>
                ...
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>เลขตัวถัง :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <?php
                    ...
                    ?>
                    <input name="car_body_inform" type="text" id="car_body_inform" maxlength="20" class='e-span10'
                        value='<?php echo $car_body_text; ?>'>
                </div>
            </div>
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>เลขตัวเครื่อง :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <input name="n_motor_inform" type="text" id="n_motor_inform" maxlength="20" class='e-span10'
                        value='<?php echo $n_moror_text; ?>'>
                </div>
                <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>ผู้รับผลประโยชน์ :</font>
                </div>
                <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                    <select name="name_gain_inform" id="name_gain_inform" class='e-span10'>
        ...
        <div class='design-ti span12' style='<?php echo $css_margin ?>'>
            <div class='font-resize-ti span3' style='margin-top:10px;margin-left:10px;'>
                <font style='color:#FFFFFF;'>ข้อมูลความคุ้มครอง</font>
            </div>
        </div>
        <div class='design-form span12' style='<?php echo $css_margin ?> margin-bottom:20px;'>
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                    ...
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        <select name="doc_type_inform" id="doc_type_inform" class='e-span10'>
                            <?php
                    ...
                    <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                        <font style='<?php echo $css_margin_font_tab ?>'>บริษัทประกันภัย :</font>
                    </div>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        <select name='com_data_inform' id='com_data_inform' class='e-span10'>
                ...
                <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                    ...
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        <select name="service_inform" id="service_inform" class='e-span10'>
                    ...
                    <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                        <font style='<?php echo $css_margin_font_tab ?>'>เลขกรมธรรม์เดิม :</font>
                    </div>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        <input id="o_insure_inform" name="o_insure_inform" type="text"
                            value='<?php echo $data_renew_array['n_insure']; ?>' class='e-span10'>
                    </div>
                </div>
                <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                    <div class='span2 e-span2' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                        <font style='<?php echo $css_margin_font_tab ?>'>วันคุ้มครอง :</font>
                    </div>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        <input id="start_date_inform" name="start_date_inform" type="text" class='e-span10'
                            value='<?php $edit_start_date = explode("-", $date_now);
                                                                                                                    $dtY = $edit_start_date[0];
                                                                                                                    echo $edit_start_date[2] . "/" . $edit_start_date[1] . "/" . $dtY; ?>'
                            placeholder='คลิกที่นี่เพื่อเลือกวันที่คุ้มครอง'>
                    </div>
                    <div class='span2 e-span2'
                        style='<?php echo $css_margin . " " . $css_margin_font ?> <?php echo $display_hide ?>'>
                    ...
                    <div class='span4 e-span4' style='<?php echo $css_margin ?> <?php echo $display_hide ?>'>
                        <select name="ty_inform" id="ty_inform" class='e-span10'>
                            ...
                            <option value="MV" selected>MV = ประกันภัยต่ออายุมิตซู </option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?> <?php echo $display_hide ?>'>
                ...
                <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                    ...
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        <input class='e-span10' type="text" id="cost_inform" name="cost_inform"
                            onkeyup='protection_html_start();' value='<?php echo number_format($data_renew[0]); ?>'>
                    </div>
                    <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                ...
                <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                    ...
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        <select class='e-span10' name="damage_out1_inform" id="damage_out1_inform"
                            onchange='protection_html_start();'>
                            ...
                            <option value="<?php echo number_format($s); ?>"><?php echo number_format($s); ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                ...
                <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                    ...
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        <select value="N" class='e-span10' name="damage_cost_inform" id="damage_cost_inform"
                            onchange='protection_html_start();'>
                            ...
                            <option value="<?php echo number_format($a); ?>"><?php echo number_format($a); ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                ...
                <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                    ...
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        <select class='e-span10' name="pa1_inform" id="pa1_inform" onchange='protection_html_start();'>
                ...
                <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                    ...
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        ...
                        <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                            <input class='e-span10' id="people_inform" type="text" name="people_inform"
                                onkeyup='protection_html_start();'
                                value='<?php echo number_format($protection_array['tickets']); ?>'>
                        </div>
                        <div class='span4 e-span4' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    ...
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        <select class='e-span10' id="pa2_inform" name="pa2_inform" onchange='protection_html_start();'>
                ...
                <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                    ...
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        <select class='e-span10' id="pa3_inform" name="pa3_inform" onchange='protection_html_start();'>
                ...
                <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                    ...
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        <select class='e-span10' id="pa4_inform" name="pa4_inform" onchange='protection_html_start();'>
                ...
                <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                    ...
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <select class='e-span10' name="none_disone_inform" id="none_disone_inform"
                                onchange='protection_html_start();'>
                                <option value="0">กรุณาเลือก</option>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?> display:none;' id='one_inform_show'>
                            <input class='e-span10' type="text" id="one_inform" name="one_inform" value=''
                                onkeyup='protection_html_start();' />
                        </div>
                    </div>
                    <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
            ...
            <div class='span12 e-span12' style='margin:auto;'>
                <div class='desing-form-insuree span12' style='margin-bottom:20px;'>
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        <div class='design-value-insuree'>
                            <div class='desize-font-deg'>
                                <font style='color:#FFFFFF;' size='4'>ค่าความคุ้มครอง</font>
                            </div>
                        </div>
                    </div>
                    <div class='span9 e-span9' style='<?php echo $css_margin ?>'>
                        ...
                        <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                            ...
                            <div class='span4 e-span4' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                                <center>
                                    <font>ทุนประกันภัย</font>
                                </center>
                            </div>
                            <!--number-->
                            <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                                <font style='<?php echo $css_margin_font_tab_right ?>' id='cost_inform_show'></font>
                            </div>
                            <!--unit-->
                            <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                                <font style='<?php echo $css_margin_font_tab ?>'>บาท</font>
                        ...
                        <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                            <!--text-->
                            <div class='span4 e-span4' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                                <font style='<?php echo $css_margin_font_tab ?>'>- ความเสียหายต่อชีวิต ร่างกาย
                                    หรืออนามัย</font>
                            </div>
                            <!--number-->
                            <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                        ...
                        <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                            ...
                            <!--number-->
                            <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                                <font style='<?php echo $css_margin_font_tab_right ?>' id='pa1_inform_show'></font>
                            </div>
                            <!--unit-->
                            <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                                <font style='<?php echo $css_margin_font_tab ?>'>บาท/คน</font>
                        ...
                        <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                            ...
                            <!--number-->
                            <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                                <font style='<?php echo $css_margin_font_tab_right ?>' id='pa2_inform_show'></font>
                            </div>
                            <!--unit-->
                            <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                                <font style='<?php echo $css_margin_font_tab ?>'>บาท/คน</font>
                        ...
                        <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                            ...
                            <!--number-->
                            <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                                <font style='<?php echo $css_margin_font_tab_right ?>' id='pa3_inform_show'></font>
                            </div>
                            <!--unit-->
                            <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                                <font style='<?php echo $css_margin_font_tab ?>'>บาท/คน</font>
                        ...
                        <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                            ...
                            <!--number-->
                            <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                                <font style='<?php echo $css_margin_font_tab_right ?>' id='pa4_inform_show'></font>
                            </div>
                            <!--unit-->
                            <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                                <font style='<?php echo $css_margin_font_tab ?>'>บาท/ครั้ง</font>
        ...
        <div class='design-form span12' style='<?php echo $css_margin ?> margin-bottom:20px;'>
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                ...
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab_right ?>'>เบี้ยสุทธิ</font>
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                    <input class='e-span10' type="text" id="pre_inform" name="pre_inform"
                        value="<?php echo number_format($data_renew[10], 2, '.', ','); ?>"
                        onkeyup="javascript:calcfunc_inform();">
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>บาท</font>
                </div>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?> <?php echo $display_hide ?>'>
                ...
                <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                    <select name="product_inform" id="product_inform" class='e-span10'>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?> <?php echo $display_hide ?>'>
                ...
                <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                    <select class='e-span10' name="rdodriver_inform" id="rdodriver_inform">
                        <option value="0">-- กรุณาเลือก --</option>
            ...
            <div class='span12 e-span12 bk-event' style='<?php echo $css_margin ?> display:none;' id='driver1_inform'>
                ...
                <div class='span10 e-span10' style='<?php echo $css_margin ?>'>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <select id="title_num1_inform" name="title_num1_inform" class='e-span10'>
                    ...
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <input type='text' name="name_num1_inform" id="name_num1_inform" class='e-span10'
                                maxlength="100" value=''>
                        </div>
                    </div>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <input type='text' name="last_num1_inform" id="last_num1_inform" class='e-span10'
                                maxlength="50" value=''>
                        </div>
                    </div>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <input type='text' name="birth_num1_inform" id="birth_num1_inform" class='e-span10'
                                maxlength="50" value=''>
                        </div>
                    </div>
                </div>
            ...
            <div class='span12 e-span12 bk-event' style='<?php echo $css_margin ?> display:none;' id='driver2_inform'>
                ...
                <div class='span10 e-span10' style='<?php echo $css_margin ?>'>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <select id="title_num2_inform" name="title_num2_inform" class='e-span10'>
                                <option value="0" selected="0">--เลือกคำนำหน้า--</option>
                                <?php
                                $select_titlename_sql = "SELECT * FROM tb_titlename";
                                $select_titlename_query = PDO_CONNECTION::fourinsure_insured()->query($select_titlename_sql);
                    ...
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <input type='text' name="name_num2_inform" id="name_num2_inform" class='e-span10'
                                maxlength="100" value=''>
                        </div>
                    </div>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <input type='text' name="last_num2_inform" id="last_num2_inform" class='e-span10'
                                maxlength="50" value=''>
                        </div>
                    </div>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <input type='text' name="birth_num2_inform" id="birth_num2_inform" class='e-span10'
                                maxlength="50" value=''>
                        </div>
                    </div>
                </div>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?> <?php echo $display_hide ?>'>
                ...
                <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                    <input class='e-span10' id="pro_dis_inform" value="0" class='span2' type="hidden"
                        name="pro_dis_inform" onkeyup="javascript:calcfunc_inform();">
                    <input class='e-span10' name="total_pro_dis_inform" type="hidden" id="total_pro_dis_inform"
                        value="0">
                    <input class='e-span10' type="hidden" id="pro_dis2_inform" name="pro_dis2_inform"
                        onkeyup="javascript:calcfunc_inform(); javascript:total_pro_dis.value=pro_dis2.value;"
                        value="0.00">
                    <input class='e-span10' value="0.00" onkeyup="javascript:calcfunc_inform();" type="text"
                        id="driver_inform" name="driver_inform">
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>บาท</font>
                </div>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?> <?php echo $display_hide ?>'>
                ...
                <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                    <input type="text" id="disone_inform" name="disone_inform" value="0.00" class='e-span10'
                        onkeyup="javascript:calcfunc_inform();">
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>บาท</font>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?> <?php echo $display_hide ?>'>
                ...
                <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                    <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                        <select onchange="javascript:calcfunc_inform();" class='e-span10' id="group3_inform"
                            name="group3_inform">
                    ...
                    <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                        <input class='e-span10' type="text" id="dis_group3_inform" value="0.00" name="dis_group3_inform"
                            readonly style='text-align:right;'><input name="total_dis4_inform" type="hidden"
                            id="total_dis4_inform" value="0" class='e-span10' style='text-align:right;'>
                    </div>
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>บาท</font>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?> <?php echo $display_hide ?>'>
                ...
                <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                    <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                        <input name="total_dis2_inform" type="hidden" id="total_dis2_inform" value="0" class='e-span10'>
                        <select onchange="javascript:calcfunc_inform();" class='e-span10' id="good_inform"
                            name="good_inform" align='right'>
                            <option selected="selected" value="0">ส่วนลด</option>
                            <option value="5">5%</option>
                            <option value="10">10%</option>
                    ...
                    <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                        <input type="text" id="goodb_inform" value="0.00" name="goodb_inform" class='e-span10' readonly
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?> <?php echo $display_hide ?>'>
                ...
                <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                    <input value="0.00" class='e-span10' type="text" id="total_pre_inform" name="total_pre_inform"
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?> <?php echo $display_hide ?>'>
                ...
                <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                    <input class='e-span10' type="text" id="total_stamp_inform" name="total_stamp_inform" value="0.00"
                        readonly style='text-align:right;'>
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>บาท</font>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?> <?php echo $display_hide ?>'>
                ...
                <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                    <input class='e-span10' type="text" id="total_vat_inform" name="total_vat_inform" value="0.00"
                        readonly style='text-align:right;'>
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>บาท</font>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                ...
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab_right ?>'>เบี้ยรวม</font>
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                    <input class='e-span10' type="text" id="total_sum_inform" name="total_sum_inform" value="0.00"
                        readonly style='text-align:right;'>
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>บาท</font>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                ...
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab_right ?>'>เบี้ย พ.ร.บ.</font>
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        <input type="hidden" id='actCheck_inform' name='actCheck_inform' value="0" readonly
                            style='text-align:right;'>
                        <input class='e-span10' type="hidden" id='prb_net_inform' name='prb_net_inform' readonly
                            style='text-align:right;'>
                        <select id="select_prb_inform" onchange="onChange(this.form), calcfunc_inform()"
                            name="select_prb_inform" class='e-span10'>
                            ...
                            <option value="<?php echo number_format($tb_act_array['net_act'], 2, '.', ','); ?>"
                                <?php if ($tb_act_array['net_act'] == $data_renew[9]) {
                                                                                                                        echo "selected";
                            ...
                            <!--<option value="645.21">110</option>
        <option value="2,203.13">120B</option>
        <option value="1,182.35">120A</option>
        <option value="3,437.91">120C</option>
        <option value="4,017.85">120D</option>
        <option value="967.28">140A</option>
        <option value="1,030.60">140AY</option>
        <option value="1,310.75">140B</option>
        <option value="1,408.12">140C</option>
        <option value="1,826.49">140D</option>
        <option value="1,805.09">142A</option>
        <option value="2,493.10">142B</option>
        <option value="2,546.60">150</option>
        <option value="645.21 ">160</option>
        <option value="2,041.56">310</option>
        <option value="2,493.10 ">320A</option>
        <option value="3,738.58">320B</option>
        <option value="7,155.09">320C</option>
        <option value="8,079.57">320D</option>
        <option value="1,698.09">320E</option>
        <option value="1,891.76">340A</option>
        <option value="1,966.66">340B</option>
        <option value="2,127.16">340C</option>
        <option value="2,718.87">340D</option>
        <option value="2,127.16 ">342A</option>
        <option value="3,288.11">342B</option>-->
                        </select>
                    </div>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        <input class='e-span10' type="hidden" id='prbNet_inform' name='prbNet_inform' value="0" readonly
                            style='text-align:right'>
                        <select name='act_sort_inform' id='act_sort_inform' class='e-span10'>
                            ...
                            $sql = "SELECT * FROM tb_comp where sort != 'VIB' AND sort != 'VIB_Y' AND sort != 'VIB_S103' ";
                            $result = PDO_CONNECTION::fourinsure_insured()->query($sql);
                            foreach ($result->fetchAll(2) as $fetcharr) {
                            ...
                            <option value='<?php echo $fetcharr["sort"] ?>' <?php echo $se ?>>
                                <?php echo insure($fetcharr["sort"]) ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        <input value="0.00" class='e-span10' type="text" id="currentValue_prb_inform"
                            name="currentValue_prb_inform" readonly style='text-align:right;'>
                    </div>
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>บาท</font>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?> <?php echo $display_hide ?>'>
                ...
                <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                    <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                        <input name="currentText_prb_inform" type="hidden" id="currentText_prb_inform" class='e-span10'
                            value="<?php if (!empty($id_act_data)) {
                                                                                                                                    echo $id_act_data;
                                                                                                                                } else {
                                                                                                                                    echo "--ไม่รวม--";
                                                                                                                                } ?>">
                        <select id="vat1_inform" onchange="javascript:calcfunc_inform();" name="vat1_inform"
                            class='e-span10'>
                    ...
                    <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                        <input value="0.00" class='e-span10' type="text" id="vat_1_inform" name="vat_1_inform" readonly
                            style='text-align:right;'>
                    </div>
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?> <?php echo $display_hide ?>'>
                ...
                <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                    <input value="0.00" class='e-span10' type="text" id="vat_2_inform" name="vat_2_inform"
                        onkeyup="javascript:calcfunc2_inform();" style='text-align:right;'>
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>บาท</font>
                </div>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                ...
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab_right ?>'>เบี้ยรวม พ.ร.บ.</font>
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                    <input value="0.00" class='e-span10' type="text" id="total_prb_inform" name="total_prb_inform"
                        readonly style='text-align:right;'>
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>บาท</font>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?> <?php echo $display_hide ?>'>
                ...
                <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                    ...
                    <select style="display:none" id="dis_vip_inform" onclick="javascript:calcfunc_inform()"
                        name="dis_vip_inform" class='span2'>
                        ...
                        <option value="15">15%</option>
                        <option value="20">20%</option>
                    </select><input name="total_vip_inform" type="hidden" id="total_vip_inform" value="0" class='span2'
                        style='text-align:right;'>

                    <!--ส่วนลดตัวแทน-->
                    <input name="currentValue_inform" type="text" id="currentValue_inform"
                        value="<?php echo $comittion_a ?>" class='e-span10' readonly="true" style='text-align:right;'>
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>%</font>
                </div>
            </div>
            <div class='span12 e-span12' style='<?php echo $css_margin ?> <?php echo $display_hide ?> display:none;'>
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'></font>
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                ...
                <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                    <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                        <select id="commition_percent_inform" onchange="javascript:com_action();"
                            name="commition_percent_inform" class='e-span10'>
                    ...
                    <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                        <input id="commition_inform" class='e-span10' onkeyup="javascript:calcfunc2_inform();"
                            value="0.00" type="text" name="commition_inform" style='text-align:right;'>
                    </div>
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>บาท</font>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                ...
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab_right ?>'>ส่วนลดลูกค้า</font>
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                    <input name="other_inform" type="text" id="other_inform" value="<?php echo number_format($data_renew[6], 2, '.', ','); ?>" class='e-span10'
                        readonly="true" style='text-align:right;'>
                    <input name="other_new_inform" type="hidden" id="other_new_inform" value="0.00" class='e-span10'
                        readonly="true">
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>บาท</font>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?> <?php echo $display_hide ?>'>
                ...
                <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                    <input id="vehicle_tax_inform" onkeyup="javascript:calcfunc_inform();" value="0.00" size="10"
                        type="text" class='e-span10' name="vehicle_tax_inform" style='text-align:right;'>
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>บาท</font>
                </div>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?> <?php echo $display_hide ?>'>
                ...
                <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                    <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                        <select id="service_charge_inform" name="service_charge_inform"
                            onchange="javascript:calcfunc_inform()" class='e-span10'>
                            <option value="0">กรุณาเลือก</option>
                    ...
                    <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                        <input name="service_charge_value_inform" type="text" id="service_charge_value_inform"
                            value="0.00" class='e-span10' readonly="true" style='text-align:right;'>
                    </div>
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>บาท</font>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                ...
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab_right ?>'>ยอดนำส่ง</font>
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                    <input class="e-span10" id="total_commition_inform" onchange="JavaScript:chkNum(this)" value="0.00"
                        type="text" name="total_commition_inform" readonly style='text-align:right;'>
                    <input class="e-span10" id="total_commition_new_inform" onchange="JavaScript:chkNum(this)"
                        value="0.00" type="hidden" name="total_commition_new_inform" readonly style='text-align:right;'>
                </div>
                <div class='span3 e-span3' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>บาท</font>
                </div>
        ...
        <div class='design-form span12'
            style='<?php echo $css_margin ?> margin-bottom:20px; <?php echo $display_hide ?>'>

            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <font style='<?php echo $css_margin_font_tab ?>'><input id="commentse1_inform" type="checkbox"
                        onclick="comment(this.value);" value="1" name="commentse1_inform">&nbsp;นัดตรวจสภาพรถ</font>
            </div>
            <!--commentse1_inform-->
                ...
                <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                    ...
                    <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                        <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                            ...
                            <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                                <input id="checkcar_date_inform" type="text" value="<?php echo date('d/m/Y') ?>"
                                    maxlength="10" class='e-span10' name="checkcar_date_inform">
                            </div>
                        </div>
                        <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                            <div class='span6 e-span6' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                            ...
                            <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                                <select id="checkcar_time_inform" name="checkcar_time_inform" class='e-span10'>
                        ...
                        <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                            ...
                            <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                                <input type='text' id="contact_name_list_inform" name="contact_name_list_inform"
                                    value="" class='e-span10'>
                            </div>
                        </div>
                        <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                            <div class='span6 e-span6' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                            ...
                            <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                                <input type='text' id="contact_number_inform" style="text-align:left" maxlength="12"
                                    class='e-span10' name="contact_number_inform" value="">
                            </div>
                        </div>
                    </div>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <font style='<?php echo $css_margin_font_tab ?>'><input id="commentse2_inform" type="checkbox"
                        onclick="comment(this.value);" value="2" name="commentse2_inform">&nbsp;ส่งกรมธรรม์</font>
            </div>
            <!--commentse2_inform-->
            <div class='span12 e-span12 bk-event' style='<?php echo $css_margin ?> display:none;' id='comment2_inform'>
                <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        <font style='<?php echo $css_margin_font_tab ?>'><input id="check_1_inform" type="radio"
                                value="1" name="check_R1_inform">&nbsp;พร้อมเก็บเงิน</font></br>
                        <font style='<?php echo $css_margin_font_tab ?>'><input id="check_2_inform" type="radio"
                                value="2" name="check_R1_inform">&nbsp;พร้อมวางบิล</font>
                    </div>
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        <div class='span6 e-span6' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                            <font style='<?php echo $css_margin_font_tab ?>'>วันที่ :</font>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <input id="date_SP_inform" type="text" value="<?php echo date('d/m/Y') ?>" maxlength="10"
                                class='e-span10' name="date_SP_inform">
                        </div>
                    </div>
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        <div class='span6 e-span6' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <input type='text' id="contact_name_list_1_inform" name="contact_name_list_1_inform"
                                value="" class='e-span10'>
                        </div>
                    </div>
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <input type='text' id="contact_number_1_inform" maxlength="12" class='e-span10'
                                name="contact_number_1_inform" value="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <font style='<?php echo $css_margin_font_tab ?>'><input id="commentse3_inform" type="checkbox"
                        onclick="comment(this.value);" value="3" name="commentse3_inform">&nbsp;จ่ายแล้ว</font>
            </div>
            <!--commentse3_inform-->
            <div class='span12 e-span12 bk-event' style='<?php echo $css_margin ?>' id='comment3_inform'>
                <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        <font style='<?php echo $css_margin_font_tab ?>'><input id="check_3_inform" type="radio"
                                value="3" name="check_R2_inform">&nbsp;จ่ายเข้าบริษัท</font></br>
                        <font style='<?php echo $css_margin_font_tab ?>'><input id="check_4_inform" type="radio"
                                value="4" name="check_R2_inform">&nbsp;จ่ายเข้าบริษัทประกัน</font>
                    </div>
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        <div class='span6 e-span6' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <input id="payment_date_inform" type="text" value="<?php echo date('d/m/Y') ?>"
                                maxlength="10" class='e-span10' name="payment_date_inform">
                        </div>
                    </div>
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        <div class='span6 e-span6' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <select id="payment_1_inform" name="payment_1_inform" class='e-span10'>
                            ...
                            <select id="instance_1_inform" name="instance_1_inform" style="display:none;"
                                class='e-span10'>
                                <option value="0">งวดชำระ</option>
                                <option value="3">3 งวด</option>
                                <option value="6">6 งวด</option>
                            </select>
                            <select id="instance_1_cut_inform" name="instance_1_cut_inform" style="display:none;"
                                class='e-span10'>
                                <option value="0">งวดชำระ</option>
                    ...
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <select id="bankoperation_1_inform" name="bankoperation_1_inform" class='e-span10'>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <font style='<?php echo $css_margin_font_tab ?>'><input id="commentse4_inform" type="checkbox"
                        onclick="comment(this.value)" value="4" name="commentse4_inform">&nbsp;กำลังทำจ่าย</font>
            </div>
            <!--commentse4_inform-->
            <div class='span12 e-span12 bk-event' style='<?php echo $css_margin ?>' id='comment4_inform'>
                <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        <font style='<?php echo $css_margin_font_tab ?>'><input id="check_5_inform" type="radio"
                                value="5" name="check_R3_inform">&nbsp;จ่ายเข้าบริษัท</font><br>
                        <font style='<?php echo $css_margin_font_tab ?>'><input id="check_6_inform" type="radio"
                                value="6" name="check_R3_inform">&nbsp;จ่ายเข้าบริษัทประกัน</font>
                    </div>
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        <div class='span6 e-span6' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                            <font style='<?php echo $css_margin_font_tab ?>'>วันที่ชำระ :</font>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <input id="payment_in_inform" type="text" value="<?php echo date('d/m/Y') ?>" maxlength="10"
                                class='e-span10' name="payment_in_inform">
                        </div>
                    </div>
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        <div class='span6 e-span6' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <select id="payment_2_inform" name="payment_2_inform" class='e-span10'>
                                <option value="0">วิธีชำระเงิน</option>
                                <option value="1">เงินสด</option>
                                <option value="2">เช็ค</option>
                                <option value="3">ตัดบัตรเครดิตเต็มจำนวน</option>
                            ...
                            <select id="instance_2_inform" name="instance_2_inform" style="display:none;"
                                class='e-span10'>
                                <option value="0">งวดชำระ</option>
                                <option value="3">3 งวด</option>
                                <option value="6">6 งวด</option>
                            </select>
                            <select id="instance_2_cut_inform" name="instance_2_cut_inform" style="display:none;"
                                class='e-span10'>
                                <option value="0">งวดชำระ</option>
                                <option value="2">2 งวด</option>
                                <option value="3">3 งวด</option>
                    ...
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <select id="bankoperation_2_inform" name="bankoperation_2_inform" class='e-span10'>
                                <option value="0">ธนาคาร</option>
                                <option value="NON">ไม่ระบุ</option>
                                <option value="SCB">ธนาคาร ไทยพาณิชย์</option>
                                <option value="KBANK">ธนาคาร กสิกร</option>
                ...
                <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                    ...
                    <div class='span3 e-span3' style='<?php echo $css_margin ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <input id="contact_number_2_inform" type='text' maxlength="12" class='e-span10'
                                name="contact_number_2_inform" value="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <font style='<?php echo $css_margin_font_tab ?>'><input id="commentse5_inform" type="checkbox"
                        onclick="comment(this.value)" value="5" name="commentse5_inform">&nbsp;ยังไม่จ่าย</font>
            </div>
            <!--commentse5_inform-->
            <div class='span12 e-span12 bk-event' style='<?php echo $css_margin ?> display:none;' id='comment5_inform'>
                <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                            <font style='<?php echo $css_margin_font_tab ?>'><input id="check_7_inform" type="radio"
                                    value="7" name="check_R4_inform">&nbsp;นัดอีกครั้ง</font>
                        </div>
                        <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                            <font style='<?php echo $css_margin_font_tab ?>'><input id="check_8_inform" type="radio"
                                    value="8" name="check_R4_inform">&nbsp;วางบิลบริษัท</font>
                        </div>
                        <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                            <font style='<?php echo $css_margin_font_tab ?>'><input id="check_9_inform" type="radio"
                                    value="9" name="check_R4_inform">&nbsp;วางบิลคู่ค้า/ดิลเลอร์</font>
                        </div>
                        <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                            <font style='<?php echo $css_margin_font_tab ?>'><input id="check_10_inform" type="radio"
                                    value="10" name="check_R4_inform">&nbsp;วางบิลตัวแทน</font>
                        </div>
                        <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                            <div class='span6 e-span6' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                                <font style='<?php echo $css_margin_font_tab ?>'><input id="check_11_inform"
                                        type="radio" value="11" name="check_R4_inform">&nbsp;บิล เครดิต</font>
                            </div>
                            <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                                <select id="D_day_inform" name="D_day_inform" class='e-span10'>
                                    <option value="0">เลือก</option>
                        ...
                        <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                            <font style='<?php echo $css_margin_font_tab ?>'><input id="check_12_inform" type="radio"
                                    value="12" name="check_R4_inform">&nbsp;ออก กธ. แล้ว</font>
                        </div>
                    </div>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        <div class='span6 e-span6' style='<?php echo $css_margin . " " . $css_margin_font ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <input type='text' id="contact_name_list_3_inform" name="contact_name_list_3_inform"
                                value="" class='e-span10'>
                        </div>
                    </div>
                    <div class='span4 e-span4' style='<?php echo $css_margin ?>'>
                        ...
                        <div class='span6 e-span6' style='<?php echo $css_margin ?>'>
                            <input type='text' id="contact_number_3_inform" maxlength="12"
                                name="contact_number_3_inform" value="" class='e-span10'>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <font style='<?php echo $css_margin_font_tab ?>'><input id="commentse6_inform" type="checkbox"
                        onclick="comment(this.value)" value="6" name="commentse6_inform">&nbsp;อื่นๆ</font>
            </div>
            <!--commentse6_inform-->
            <div class='span12 e-span12 bk-event' style='<?php echo $css_margin ?> display:none;' id='comment6_inform'>
                <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                    <font style='<?php echo $css_margin_font_tab ?>'>
                        <textarea rows="3" style="width:40%" rows='4' id="other_s_inform" name="other_s_inform"
            ...
            <div class='span12 e-span12' style='<?php echo $css_margin ?>'>
                <font style='<?php echo $css_margin_font_tab ?>'><input id="commentse7_inform" type="checkbox"
                        onclick="comment(this.value)" value="7" name="commentse7_inform">&nbsp;แมสวิ่งพร้อมเก็บเงิน
                </font>
            </div>
            <!--commentse7_inform-->
    ...
    if (e.keyCode == 8) {
        ...
        switch (d.tagName.toUpperCase()) {
            ...
            case 'INPUT':
                ...
                break;
            case 'DIV':
                preventKeyPress = d.readOnly || d.disabled || !(d.attributes["contentEditable"] && d.attributes[
...
function onChange(object) {
    ...
    // object.currentValue_inform.value = arrayFromPHP[Current2];
...
$("#cartype_inform").change(function() {
    ...
    var options = {
        ...
        success: function(msg) {
            ...
            if (returnedArray != null) {
                for (var i = 0; i < returnedArray.length; ++i) {
                    car_id.append("<option value='" + returnedArray[i].Id + "'>" + returnedArray[i]
                        .Name + "</option>");
                }
            } else {
                return false;
...
function inform_save() {
    ...
    if ($("#agent_inform").val() == 'N') {
        ...
        return false;
    } else if (document.getElementsByName('emp_inform')[0].value == '') {
        $("#emp_inform").focus();
    ...
    // นัดตรวจสภาพ
        ...
        return false;
    } else if ((document.getElementById('commentse1_inform').checked == true) && $("#contact_name_list_inform").val() ==
        '') {
        $("#contact_name_list_inform").focus();
        alert('กรุณากรอกชื่อผู้ติดต่อ');
        return false;
    } else if ((document.getElementById('commentse1_inform').checked == true) && $("#contact_number_inform").val() ==
        '') {
    ...
    // ส่งกรมธรรม์
        ...
        alert('กรุณากรอกชื่อผู้ติดต่อ');
        return false;
    } else if ((document.getElementById('commentse2_inform').checked == true) && $("#contact_number_1_inform").val() ==
        '') {
    ...
    // จ่ายแล้ว
        ...
        return false;
    } else if ((document.getElementById('commentse3_inform').checked == true) && $("#payment_1_inform").val() == '0') {
        $("#payment_1_inform").focus();
        alert('กรุณาเลือกวิธีชำระเงิน');
        return false;
    } else if ((document.getElementById('commentse3_inform').checked == true) && $("#payment_1_inform").val() == '5' &&
        $("#instance_1_inform").val() == '0') {
        $("#instance_1_inform").focus();
        alert('กรุณาเลือกจำนวนงวดชำระ');
        return false;
    } else if ((document.getElementById('commentse3_inform').checked == true) && $("#payment_1_inform").val() != '1' &&
    ...
    // กำลังทำจ่าย
        ...
        alert('กรุณาเลือกประเภทการจ่ายเงิน');
        return false;
    } else if ((document.getElementById('commentse4_inform').checked == true) && $("#payment_2_inform").val() == '0') {
        $("#payment_2_inform").focus();
        alert('กรุณาเลือกวิธีชำระเงิน');
        return false;
    } else if ((document.getElementById('commentse4_inform').checked == true) && $("#payment_2_inform").val() == '5' &&
        $("#instance_2_inform").val() == '0') {
        $("#instance_2_inform").focus();
        alert('กรุณาเลือกจำนวนงวดชำระ');
        return false;
    } else if ((document.getElementById('commentse4_inform').checked == true) && $("#payment_2_inform").val() != '1' &&
        $("#payment_2_inform").val() != '7' && $("#payment_2_inform").val() != '8' && $("#bankoperation_2_inform")
        .val() == '0') {
        $("#bankoperation_2_inform").focus();
        alert('กรุณาเลือกธนาคาร');
        return false;
    } else if ((document.getElementById('commentse4_inform').checked == true) && $("#contact_number_2_inform").val() ==
        '') {
    ...
    // ยังไม่จ่าย
            ...
            document.getElementById('check_9_inform').checked == false) && (document.getElementById('check_10_inform')
        ...
        alert('กรุณากรอกชื่อผู้ติดต่อ');
        return false;
    } else if ((document.getElementById('commentse5_inform').checked == true) && $("#contact_number_3_inform").val() ==
        '') {
...
function js_title_inform() {
    if ($(".class_title_inform").val() == 'บจ.' || $(".class_title_inform").val() == 'หจก.' || $(".class_title_inform")
        .val() == 'บมจ.') {
        $("#show_name_form").removeClass("span6 e-span6");
        $("#show_name_form").addClass("span12 e-span12");
        $("#last_inform").val("-");
        $("#name_inform").attr("placeholder", "ป้อนชื่อบริษัท");
        $("#show_last_form").hide();
    } else {
        $("#show_name_form").removeClass("span12 e-span12");
        $("#show_name_form").addClass("span6 e-span6");
        $("#name_inform").attr("placeholder", "ป้อนชื่อจริง");
        $("#last_inform").val(
            "<?php if (!empty($data_renew_array['last'])) {
                        echo $data_renew_array['last'];
                    } else {
                        echo '-';
                    } ?>");
