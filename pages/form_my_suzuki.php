...
<div style='width:97%;' class='span12'>
<button class='btn btn-success' onclick='show_form("my");'>ทำข้อมูลผู้จองรถยนต์/ลูกค้าคาดหวัง</button>
</div>
<div class='span12'>
<!--เริ่มบรรทัดไหม่-->
</div>
<div style='width:97%;' id='show_form_car'>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="widget-box">                                        
					...
					<div class='span12'>
					<b class='tap_font'>รายการจองรถยนต์ <?php echo $dealer_name; ?></b>
					</div>
                       <table width="100%" border="0" cellpadding="0" cellspacing="0"  class="table table-striped table-bordered" id="my_car">
                        <thead> 
...
<div class='span5' style='margin-left:0px;'  id='my_pie'>
	...
	$("#my_car").dataTable(
{
		...
		"ajax":{
			'url':'ajax/ajax_select_my_car.php'
		},
		"columnDefs": [
		{
			"targets": 0,
	...
	function show_detail_car(id_mo_car,name_mo_car)
	{
		...
		function show_form(form)
		{
			...
			{
			$("#show_form_car").load("ajax/ajax_form_my_car.php");
			}
...
$('#my_pie').html('<center><br><br><br><br><img src="img4/loadingIcon.gif"  >&nbsp;<img src="img4/loadingIcon.gif"  ></center>').load("ajax/ajax_my_highcharts.php");
//show_form("my");
	</script>
