    ...
    <div class="span12 inner">
            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div id="collapse4" class="body">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" class="table table-striped table-bordered" id="example1" style="border: 0;">
                            <thead>
                                <tr class="info">
                                    <td width="40">
        ...
        <script>
            var table = $('#example1').DataTable({
                ...
                //"ajax": "ajax/Ajax_Individuals.php?person=1",
                "ajax": {
            ...
            function print_Insurance(IDDATA) {
                ...
                window.open("print/print_Insurance.php?IDDATA=" + IDDATA);
            }

            function print_Insurance_new(IDDATA) {
                // window.open("print/print_Insurance_new.php?IDDATA="+IDDATA, "_blank", "toolbar=no, scrollbars=yes, resizable=yes, top=0, left=0,fullscreen=yes");  
                window.open("print/print_Insurance_new.php?IDDATA=" + IDDATA);
            }
        </script>
