...
<div style="width:806px;float:left;">
                                ...
                                <span id="notdate" style="display:none;"><input type="text" style="color:#000;" name="txtsearch" id="txtsearch" placeholder="คำค้นหา" required/></span>
                                <span id="possenddate">
                                  <input type="text"  id="txtstartdate" name="txtstartdate" style="color:#000;"  class="datepick"  placeholder="เริ่มวันที่" value="">  ถึง   <input type="text"  class="datepick"  id="txtenddate" style="color:#000;"  placeholder="วันที่" name="txtenddate" value="">
                                </span>
