...
$pdf->Image('./images/update_admin_telephone_approve/1.jpg', -1, 0, 210);

$pdf->SetY(197);
$pdf->SetX(50);
$pdf->Cell(70, 5, iconv('UTF-8', 'TIS-620', $nameDealer), 0,0, 'L');
...
$pdf->AddPage();
$pdf->Image('./images/update_admin_telephone_approve/2.jpg', 0, 0, 210);
